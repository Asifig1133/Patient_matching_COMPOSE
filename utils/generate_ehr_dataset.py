...
ehr_data = pd.read_csv('/content/COMPOSE-master/ehr_data/records.csv', dtype={'claim_id':str})
...
# print(idx)
train_idx, test_idx = train_test_split(idx, test_size=0.4, random_state=123, shuffle=True)
