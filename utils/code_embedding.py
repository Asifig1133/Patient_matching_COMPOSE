...
model_loc = '/content/pretrained_bert_tf/biobert_pretrain_output_all_notes_150000/biobert_pretrain_output_all_notes_150000/'
...
diag_df = pd.read_csv('/content/COMPOSE-master/ehr_data/diag_list.csv')
procedure_df = pd.read_csv('/content/COMPOSE-master/ehr_data/procedure_list.csv')
product_df = pd.read_csv('/content/COMPOSE-master/ehr_data/product_list.csv')
